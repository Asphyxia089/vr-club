(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider1")) new core(".slider1", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".slider2")) new core(".slider2", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".slider3")) new core(".slider3", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (passwordField && showPasswordBtn) showPasswordBtn.addEventListener("click", (function() {
            if ("password" === passwordField.type) passwordField.type = "text"; else passwordField.type = "password";
        }));
    }));
    document.addEventListener("DOMContentLoaded", (function() {
    ...
    const input = document.getElementById("datePopup");
    if (input) {
    ...
    if (birthdate) birthdate.addEventListener("change", (function() {
        var selectedDate = new Date(this.value);
        var today = new Date;
        if (selectedDate > today) {
            alert("Вы не можете выбрать день рождения позже сегодняшнего дня.");
            this.value = "";
        }
    }));
    const passwordInput = document.getElementById("passwordReg");
    const passwordError = document.getElementById("password-error");
    if (passwordInput && passwordError) passwordInput.addEventListener("input", (function() {
